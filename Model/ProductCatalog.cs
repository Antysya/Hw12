...
namespace BlazorWASM.Model
{
    public class ProductCatalog : IProductCatalog
    {
        ...
        {
            new Product(1, "Чистый код", 500m, new Category(1, "Книги"), "image/1.jpg"),
            new Product(2, "Код, который умещается в голове", 1000m, new Category(1, "Книги"), "image/2.jpg"),
            new Product(3, "Рефакторинг", 100m, new Category(1, "Книги"), "image/3.jpg")
            };
